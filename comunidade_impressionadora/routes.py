...
def login():
    ...
    if form_login.validate_on_submit() and "botao_submit_login" in request.form:
        ...
        if usuario and bcrypt.check_password_hash(usuario.senha, form_login.senha.data):
            ...
            flash('Login realizado com sucesso no e-mail {}'.format(form_login.email.data), 'alert-success')
    ...
    if form_criarconta.validate_on_submit() and "botao_submit_criarconta" in request.form:
        ...
        flash('Conta criada com sucesso para o e-mail {}'.format(form_criarconta.email.data), 'alert-success')
        return redirect(url_for('home'))
...
def sair():
    logout_user()
    flash('Voce saiu da página. Crie uma conta ou faça login para voltar', 'alert-success')
    return redirect(url_for('home'))
